# -*- coding: utf-8 -*-
"""Provision third-party Python deps (pandas/scikit-learn/scipy) that are not
bundled with QGIS, matching the running interpreter.
...
BASE_URL = "https://github.com/caioarantes/precision_zones/raw/main/"
...
_QGIS_PROVIDED = ("numpy", "matplotlib")
...
def _strip_qgis_provided(target):
    """Remove numpy/matplotlib (provided by QGIS) from a target dir."""
    try:
    ...
    def run(self):
        try:
            ...
            self.download_done.emit(
                ...
                f"{current_tag()}. Install pandas, scikit-learn and scipy in the "
                "QGIS Python environment manually.")
